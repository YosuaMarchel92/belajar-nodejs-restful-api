...
import { createManyTestContact, createTestContact, createTestUser, getTestContact, removeAllTestContacts, removeTestUser } from "./test-util.test"
    ...
    it('should reject if request is not valid', async () => {
        const result = await supertest(web)
            ...
            .send({
                ...
                last_name: "test",
                email: "test",
                phone: "080900012093124882139112312310000"
            });
